  ...
  'g-inline-flex g-items-center g-justify-center g-rounded-md g-text-sm g-font-medium g-transition-colors focus-visible:g-outline-none focus-visible:g-ring-1 focus-visible:g-ring-ring disabled:g-pointer-events-none disabled:g-opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'g-border g-border-solid g-border-slate-400 g-bg-transparent g-shadow-sm hover:g-bg-gray-500/15 hover:g-text-accent-foreground',
        primaryOutline:
        ...
        subtle:
          'g-bg-gray-500/10 hover:g-bg-gray-500/20 g-text-accent-foreground g-border g-border-solid g-border-transparent',
