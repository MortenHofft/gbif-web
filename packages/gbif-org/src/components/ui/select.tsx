  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'g-flex g-h-11 g-w-full g-items-center g-justify-between g-whitespace-nowrap g-rounded-md g-border g-border-input g-bg-transparent g-px-3 g-py-2 g-text-base g-shadow-sm placeholder:g-text-muted-foreground focus:g-outline-none focus:g-ring-1 focus:g-ring-ring disabled:g-cursor-not-allowed disabled:g-opacity-50 [&>span]:g-line-clamp-1 sm:g-h-9 sm:g-text-sm',
