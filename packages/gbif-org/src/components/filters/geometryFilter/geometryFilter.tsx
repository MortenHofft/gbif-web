            ...
            <div className="g-px-4 g-py-1.5">
              <div>
                <Tabs defaultValue="gbifLocationTabMap">
                  ...
                  >
                    <TabsTrigger value="gbifLocationTabMap" className="g-min-h-11 g-px-4">
                      <FormattedMessage id="filterSupport.location.map" />
                    </TabsTrigger>
                    <TabsTrigger value="gbifLocationTabGeometry" className="g-min-h-11 g-px-4">
                      <FormattedMessage id="filterSupport.location.geometry" />
                    </TabsTrigger>
                    <TabsTrigger value="gbifLocationTabRange" className="g-min-h-11 g-px-4">
                      <FormattedMessage id="filterSupport.location.range" />
                    </TabsTrigger>
                    <TabsTrigger value="gbifLocationTabRecent" className="g-min-h-11 g-px-4">
