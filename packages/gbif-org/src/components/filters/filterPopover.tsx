      ...
      <Dialog open={controlledOpen} onOpenChange={setControlledOpen}>
        ...
        >
          ...
          <button
            ...
            className="g-absolute g-end-2 g-top-2 g-z-10 g-inline-flex g-items-center g-justify-center g-min-w-11 g-min-h-11 g-rounded g-text-slate-600 hover:g-bg-slate-100"
          >
            <MdClose />
          </button>
