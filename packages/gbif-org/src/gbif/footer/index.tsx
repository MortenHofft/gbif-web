...
const footerLink = 'g-inline-flex g-items-center g-py-2 g-min-h-11 hover:g-underline';
const socialLink =
...
export function Footer() {
  ...
  const linkedinLabel = intl.formatMessage({
    id: 'footer.socialLinkedin',
    defaultMessage: 'GBIF on LinkedIn',
  });
  const facebookLabel = intl.formatMessage({
    id: 'footer.socialFacebook',
    defaultMessage: 'GBIF on Facebook',
  });
  const blueskyLabel = intl.formatMessage({
    id: 'footer.socialBluesky',
    defaultMessage: 'GBIF on Bluesky',
  });
  const mastodonLabel = intl.formatMessage({
    id: 'footer.socialMastodon',
    defaultMessage: 'GBIF on Mastodon',
  });
  const vimeoLabel = intl.formatMessage({
    id: 'footer.socialVimeo',
    defaultMessage: 'GBIF on Vimeo',
  });

  return (
    <footer className="g-text-white" role="contentinfo">
      <section className="g-bg-[#686a68] g-py-6 g-px-4 g-text-base">
        <nav aria-label={footerNavLabel}>
          ...
          <address className="g-pt-4 g-not-italic g-flex g-w-full g-justify-center g-flex-wrap g-items-center">
      ...
      <section className="g-bg-[#5b5b5b] g-flex g-w-full g-justify-center g-py-6 g-px-6 g-text-base">
        <DynamicLink
      ...
      <section className="g-bg-[#414141] g-text-[#414141] g-py-6 g-px-6">
        ...
        >
          ...
          <li>
            <a href="https://vimeo.com/gbif" aria-label={vimeoLabel} className={socialLink}>
