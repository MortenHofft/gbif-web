export const helmetConfig = {
  ...
  contentSecurityPolicy: {
    directives: {
      ...
      // frameAncestors is intentionally absent here. Helmet v7 refuses to send both
      // X-Frame-Options and frame-ancestors simultaneously (they conflict). Widget routes
      // that need iframe embedding handle frame-ancestors in a dedicated middleware in
